...
const playlistSongs_entity_1 = require("./playlistSongs.entity");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => playlistSongs_entity_1.PlaylistSongs, playlistSongs => playlistSongs.playlist),
